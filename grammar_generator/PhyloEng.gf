concrete PhyloEng of Phylo = open SyntaxEng, ParadigmsEng, ConstructorsEng in {
    lincat
        ...
        Output = NP;
    lin
        f_names_extraction_web i_resource_WebURL o_resource_SetOfSciName = mkS and_Conj (mkS (mkCl names_extraction_web_in i_resource_WebURL)) (mkS (mkCl names_extraction_web_out o_resource_SetOfSciName ));
        ...
        f_taxon_to_species_by_genome i_resource_taxon o_resource_taxon o_resource_SetOfSciName = mkS and_Conj (mkS (mkCl taxon_to_species_by_genome_in (mkV2 "require") i_resource_taxon)) (mkS (mkCl taxon_to_species_by_genome_out (mkV2 "return") (mkNP and_Conj o_resource_taxon o_resource_SetOfSciName)));
        ...
        f_phylotastic_ResolvedScientificNames_OT_TNRS_POST i_resource_SetOfSciName o_resource_SetOfNames o_resource_SetOfTaxon o_resource_SetOfResolvedName = mkS and_Conj (mkS (mkCl i_resource_SetOfSciName phylotastic_ResolvedScientificNames_OT_TNRS_POST_in)) (mkS (mkCl (mkNP and_Conj (mkListNP o_resource_SetOfNames (mkListNP o_resource_SetOfTaxon o_resource_SetOfResolvedName))) phylotastic_ResolvedScientificNames_OT_TNRS_POST_out));
        ...
        f_phylotastic_GetPhylogeneticTree_OT_GET i_resource_SetOfTaxon o_resource_speciesTree o_resource_Tree = mkS and_Conj (mkS (mkCl phylotastic_GetPhylogeneticTree_OT_GET_in i_resource_SetOfTaxon)) (mkS (mkCl phylotastic_GetPhylogeneticTree_OT_GET_out (mkNP both7and_DConj o_resource_speciesTree o_resource_Tree)));
        f_phylotastic_GetAllSpeciesFromTaxon_OT_GET i_resource_taxon o_resource_taxon o_resource_SetOfSciName = mkS and_Conj (mkS (mkCl i_resource_taxon phylotastic_GetAllSpeciesFromTaxon_OT_GET_in)) (mkS (mkCl (mkNP both7and_DConj o_resource_taxon o_resource_SetOfSciName) phylotastic_GetAllSpeciesFromTaxon_OT_GET_out));
        ...
        f_tree_scaling_operation i_resource_Tree o_resource_Tree = mkS and_Conj (mkS (mkCl tree_scaling_operation_in (mkV2 "require") i_resource_Tree)) (mkS (mkCl tree_scaling_operation_out (mkV2 "return") o_resource_Tree ));
        ...
        f_phylotastic_FindScientificNamesFromWeb_GNRD_GET i_resource_WebURL o_resource_SetOfSciName o_resource_SetOfNames = mkS and_Conj (mkS (mkCl i_resource_WebURL phylotastic_FindScientificNamesFromWeb_GNRD_GET_in)) (mkS (mkCl (mkNP both7and_DConj o_resource_SetOfSciName o_resource_SetOfNames) phylotastic_FindScientificNamesFromWeb_GNRD_GET_out));
        f_gene_tree_scaling i_resource_geneTree o_resource_geneTree = mkS and_Conj (mkS (mkCl gene_tree_scaling_in i_resource_geneTree)) (mkS (mkCl gene_tree_scaling_out o_resource_geneTree ));
        ...
        f_openTree_GetScientificNameFromAName_GET i_resource_Name o_resource_ScientificName = mkS and_Conj (mkS (mkCl openTree_GetScientificNameFromAName_GET_in (mkV2 "require") i_resource_Name)) (mkS (mkCl openTree_GetScientificNameFromAName_GET_out (mkV2 "return") o_resource_ScientificName ));
        f_openTree_GetTaxonomyNameFromSciName_GET i_resource_ScientificName o_resource_taxon = mkS and_Conj (mkS (mkCl openTree_GetTaxonomyNameFromSciName_GET_in (mkV2 "require") i_resource_ScientificName)) (mkS (mkCl openTree_GetTaxonomyNameFromSciName_GET_out (mkV2 "return") o_resource_taxon ));
        f_common_name_to_scientific_name i_resource_Name o_resource_ScientificName = mkS and_Conj (mkS (mkCl common_name_to_scientific_name_in (mkV2 "require") i_resource_Name)) (mkS (mkCl common_name_to_scientific_name_out (mkV2 "return") o_resource_ScientificName ));
        ...
        f_phylotastic_GenerateGeneTree_From_Genes i_resource_SetOfGeneStrings o_resource_geneTree = mkS and_Conj (mkS (mkCl phylotastic_GenerateGeneTree_From_Genes_in i_resource_SetOfGeneStrings)) (mkS (mkCl phylotastic_GenerateGeneTree_From_Genes_out o_resource_geneTree ));
        ...
        f_phylogeny_based_extraction i_resource_SetOfResolvedName o_resource_speciesTree = mkS and_Conj (mkS (mkCl phylogeny_based_extraction_in (mkV2 "require") i_resource_SetOfResolvedName)) (mkS (mkCl phylogeny_based_extraction_out (mkV2 "return") o_resource_speciesTree ));
        ...
        f_names_extraction_tree i_resource_geneTree o_resource_SetOfSciName = mkS and_Conj (mkS (mkCl names_extraction_tree_in i_resource_geneTree)) (mkS (mkCl names_extraction_tree_out o_resource_SetOfSciName ));
        f_phylotastic_ExtractSpeicesName_From_Gene_Tree_GET i_resource_geneTree o_resource_SetOfSciName o_resource_SetOfNames = mkS and_Conj (mkS (mkCl i_resource_geneTree phylotastic_ExtractSpeicesName_From_Gene_Tree_GET_in)) (mkS (mkCl (mkNP both7and_DConj o_resource_SetOfSciName o_resource_SetOfNames) phylotastic_ExtractSpeicesName_From_Gene_Tree_GET_out));
        ...
        f_names_resolution_operation i_resource_SetOfSciName o_resource_SetOfTaxon = mkS and_Conj (mkS (mkCl names_resolution_operation_in (mkV2 "require") i_resource_SetOfSciName)) (mkS (mkCl names_resolution_operation_out (mkV2 "return") o_resource_SetOfTaxon ));
        ...
        f_country_code_to_name i_resource_CountryCode o_resource_CountryName = mkS and_Conj (mkS (mkCl country_code_to_name_in (mkV2 "require") i_resource_CountryCode)) (mkS (mkCl country_code_to_name_out (mkV2 "return") o_resource_CountryName ));
        f_tree_comparison i_resource_SetOfPhylogenyTrees = mkS (mkCl tree_comparison_in i_resource_SetOfPhylogenyTrees);
        f_phylotastic_ResolvedScientificNames_GNR_TNRS_GET i_resource_SetOfSciName o_resource_SetOfNames o_resource_SetOfResolvedName o_resource_SetOfTaxon = mkS (mkCl phylotastic_ResolvedScientificNames_GNR_TNRS_GET_in (mkV2V (mkV "use") noPrep to_Prep) i_resource_SetOfSciName (mkVP (mkV2 "extract") (mkNP and_Conj (mkListNP o_resource_SetOfNames (mkListNP o_resource_SetOfResolvedName o_resource_SetOfTaxon))) ));
        ...
        o_resource_SetOfNames = mkNP( mkCN (mkN "a set of names"));
    oper
        names_extraction_web_in = mkNP (mkCN (mkN "names_extraction_web's input"));
        names_extraction_web_out = mkNP (mkCN (mkN "output of names_extraction_web"));
        tree_retrieval_operation_out = mkNP (mkCN (mkN "output of tree_retrieval_operation"));
        ...
        taxon_to_species_by_genome_in = mkNP (mkCN (mkN "taxon_to_species_by_genome"));
        taxon_to_species_by_genome_out = mkNP (mkCN (mkN "it"));
        ...
        phylotastic_ResolvedScientificNames_OT_TNRS_POST_in = mkNP (mkCN (mkN "phylotastic_ResolvedScientificNames_OT_TNRS_POST's input"));
        phylotastic_ResolvedScientificNames_OT_TNRS_POST_out = mkNP (mkCN (mkN "output of phylotastic_ResolvedScientificNames_OT_TNRS_POST"));
        ...
        phylotastic_GetPhylogeneticTree_OT_GET_out = mkNP (mkCN (mkN "output of phylotastic_GetPhylogeneticTree_OT_GET"));
        phylotastic_GetAllSpeciesFromTaxon_OT_GET_in = mkNP (mkCN (mkN "phylotastic_GetAllSpeciesFromTaxon_OT_GET's input"));
        ...
        phylotastic_FindScientificNamesFromWeb_GNRD_GET_in = mkNP (mkCN (mkN "phylotastic_FindScientificNamesFromWeb_GNRD_GET's input"));
        phylotastic_FindScientificNamesFromWeb_GNRD_GET_out = mkNP (mkCN (mkN "output of phylotastic_FindScientificNamesFromWeb_GNRD_GET"));
        gene_tree_scaling_in = mkNP (mkCN (mkN "input of gene_tree_scaling"));
        gene_tree_scaling_out = mkNP (mkCN (mkN "output of gene_tree_scaling"));
        ...
        google_ConvertCountryCodeToName_GET_out = mkNP (mkCN (mkN "output of google_ConvertCountryCodeToName_GET"));
        taxonomy_based_extraction_in = mkNP (mkCN (mkN "taxonomy_based_extraction"));
        taxonomy_based_extraction_out = mkNP (mkCN (mkN "it"));
        openTree_GetScientificNameFromAName_GET_in = mkNP (mkCN (mkN "openTree_GetScientificNameFromAName_GET"));
        openTree_GetScientificNameFromAName_GET_out = mkNP (mkCN (mkN "it"));
        ...
        phylotastic_GenerateGeneTree_From_Genes_in = mkNP (mkCN (mkN "phylotastic_GenerateGeneTree_From_Genes's input"));
        phylotastic_GenerateGeneTree_From_Genes_out = mkNP (mkCN (mkN "output of phylotastic_GenerateGeneTree_From_Genes"));
        ...
        names_extraction_tree_in = mkNP (mkCN (mkN "names_extraction_tree's input"));
        names_extraction_tree_out = mkNP (mkCN (mkN "output of names_extraction_tree"));
        phylotastic_ExtractSpeicesName_From_Gene_Tree_GET_in = mkNP (mkCN (mkN "input of phylotastic_ExtractSpeicesName_From_Gene_Tree_GET"));
        phylotastic_ExtractSpeicesName_From_Gene_Tree_GET_out = mkNP (mkCN (mkN "output of phylotastic_ExtractSpeicesName_From_Gene_Tree_GET"));
        taxon_to_species_operation_in = mkNP (mkCN (mkN "taxon_to_species_operation's input"));
        ...
        look_up_taxonomy_out = mkNP (mkCN (mkN "output of look_up_taxonomy"));
}